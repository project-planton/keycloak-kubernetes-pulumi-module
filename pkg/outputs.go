...
import (
	"github.com/plantoncloud/planton-cloud-apis/zzgo/cloud/planton/apis/code2cloud/v1/kubernetes/keycloakkubernetes"
...
func PulumiOutputToStackOutputsConverter(pulumiOutputs auto.OutputMap,
	input *keycloakkubernetes.KeycloakKubernetesStackInput) *keycloakkubernetes.KeycloakKubernetesStackOutputs {
	return &keycloakkubernetes.KeycloakKubernetesStackOutputs{
