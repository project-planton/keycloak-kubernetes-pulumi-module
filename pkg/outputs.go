...
import (
	"github.com/plantoncloud/planton-cloud-apis/zzgo/cloud/planton/apis/code2cloud/v1/kubernetes/keycloakkubernetes/model"
...
func PulumiOutputToStackOutputsConverter(pulumiOutputs auto.OutputMap,
	input *model.KeycloakKubernetesStackInput) *model.KeycloakKubernetesStackOutputs {
	return &model.KeycloakKubernetesStackOutputs{
